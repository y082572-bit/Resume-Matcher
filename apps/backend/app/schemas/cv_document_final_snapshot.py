...
class FinalDocxSnapshotBuildStatus(StrEnum):
    ...
    # each corresponds 1:1 to a FinalSnapshotSaveStatus of the same cause
    # that only a real SQL-backed FinalDocxSnapshotRepository can ever
    # return; InMemoryFinalDocxSnapshotRepository never produces these.
